...
assert.match(styles, /\.eaglebridge-note-assets-card\.is-selected\s*\{[\s\S]*border-color: #fff/);
assert.match(source, /event\.shiftKey && this\.assetSelectionAnchorKey/);
assert.match(source, /event\.ctrlKey \|\| event\.metaKey/);
assert.match(source, /items\.slice\(start, end \+ 1\)/);
assert.match(source, /renderAssetStatusMarkers\(card, item, isTrashedItem\)/);
assert.match(styles, /\.eaglebridge-asset-source-marker\.is-eagle/);
